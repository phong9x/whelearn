...
/* --------------------------------------------------------------------- */
(function($) {
	$("#uniform-checkbox_image").click(function (){
	    if($('#uniform-checkbox_video span').hasClass('checked')){
	    	$('#uniform-checkbox_video').click();
	    } 
	});
})(jQuery);
...
//        url: 'http://localhost:9999/program/create',
//      }
//      
//      ]
//    });
...
function appendItem() {
	console.log(">>>>>>>>>>>>>>>>");
	  $("#list_append_item").append(
			  '<div class="border_control append_item">'+
              '<div style="width: 37%" class="group_item">'+
               ' <label class="sub_label">날짜</label>'+
                '<div class="sub_input">'+
                 ' <input name="dateLearn" value="" onblur="changeInputTimeLearn()" type="text" data-date-format="yyyy/mm/dd"  class="form-control input-small date-picker "/>'+
                '</div>'+
              '</div>'+
              '<div class="group_item">'+
                '<label class="sub_label">시간</label>'+
                '<div class="sub_input">'+
                  '<div class="item_time">'+
                  	'<input type="text" name="from" value="" onblur="changeInputTimeLearn()" style="width: 100px;" class="form-control timepicker timepicker-24"/>'+
                  '</div>'+
                  '<div class="item_time"><span class="input-group-addon">~</span><jsp:text/></div>'+
                  '<div class="item_time">'+
                   ' <input type="text" name="to" value="" onblur="changeInputTimeLearn()" style="width: 100px;" class="form-control timepicker timepicker-24"/>'+
                  '</div>'+
                '</div>'+
              '</div>'+
              '<div class="trash group_item"><a  href="javascript:;" class="trash_icon detele_item"><i class="fa fa-remove"><jsp:text/></i><jsp:text/></a><jsp:text/></div>'+
            '</div>'
	  );   
	  if (!$(".date-picker").length) return;
