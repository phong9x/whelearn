...
@NamedQueries ( {
  @NamedQuery ( name="ProgramRegisterEntityCustom.countAll", query="SELECT COUNT(x) FROM ProgramRegisterEntity x" )
} )
public class ProgramRegisterEntityCustom implements Serializable {
    ...
    private ProgramEntityCustom program     ;


    //----------------------------------------------------------------------
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public ProgramRegisterEntityCustom() {
		super();
    }
    ...
    public void setProgram( ProgramEntityCustom program ) {
        this.program = program;
    }
    public ProgramEntityCustom getProgram() {
        return this.program;
    }
