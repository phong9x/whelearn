...
(function($) {
  ...
  $("form").on("submit", function() {
    ...
    var checkboxList = form.find(".checkbox-list.required:visible");
  ...
  $("form").find(".checkbox-list.required").each(function() {
...
(function($) {
	  ...
	  $("#form_required").find(".checkbox-list.required").each(function() {
	    var thisCheckboxList = $(this);
